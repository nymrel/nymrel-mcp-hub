...
The read-only catalog includes a seventh tool, `get_read_result`, for reads that outlast the synchronous HTTP wait. Railway reports deployment `c347ceb9-ccdb-4f8c-b767-2cc50ad1e116` running from commit `556f70bf5517eceb5c9b191398caf6c155bd6060` on 2026-09-23 UTC; that exact source commit contains the seventh tool. This is deployment/source evidence, not an authenticated catalog scan or a regular ChatGPT connection. The earlier deployment receipt below describes the initial six-tool release.
